...
function removeHide(){
  if(currentPage<5 && currentPage>1){
    document.querySelector(`.mainpic>a:nth-child(${currentPage})`).classList.remove('hide');
    document.querySelector(`.mainpic>a:nth-child(${currentPage-1})`).classList.add('hide');
    document.querySelector(`.minipic>img:nth-child(${currentPage})`).classList.add('a');
    document.querySelector(`.minipic>img:nth-child(${currentPage-1})`).classList.remove('a');
    currentPage +=1;
  }
    ...
    document.querySelector(`.mainpic>a:nth-child(${currentPage})`).classList.remove('hide');
    document.querySelector(`.minipic>img:nth-child(${currentPage})`).classList.add('a');
    document.querySelector(`.minipic>img:nth-child(${5})`).classList.remove('a');
    currentPage +=1;
  }
}
...
function reverse_removeHide(){
  if(currentPage<5 && currentPage>1){
    document.querySelector(`.mainpic>a:nth-child(${currentPage-1})`).classList.remove('hide');
    document.querySelector(`.mainpic>a:nth-child(${currentPage})`).classList.add('hide');
    document.querySelector(`.minipic>img:nth-child(${currentPage-1})`).classList.add('a');
    document.querySelector(`.minipic>img:nth-child(${currentPage})`).classList.remove('a');
    currentPage -=1;
  }
  else if(currentPage==5){
    document.querySelector(`.mainpic>a:nth-child(${currentPage-1})`).classList.remove('hide');
    ...
    document.querySelector(`.mainpic>a:nth-child(${currentPage})`).classList.add('hide');
    document.querySelector(`.mainpic>a:nth-child(${5})`).classList.remove('hide');
